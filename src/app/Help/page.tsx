        ...
        <div className="flex flex-col sm:flex-col md:flex-row lg:flex-row justify-between gap-12">
          ...
          <div className="w-full lg:w-2/3 space-y-8">
            ...
            <div className="space-y-3">
              ...
              <p className="text-[13px] font-[500] text-[#111111] ">If you enter your PAN information at checkout, youwill be able to pay for your order with PayTM or a local credit or debit card.</p>
            ...
            <div className="text-[#111111]">
              ...
              <div className="space-y-6 mt-4">
                ...
                <div>
                  <p className="ext-[18px] font-[700]">Why donot I see Apple Pay as an option?</p>
                  <p className="text-[16px] font-[400] mt-2">
