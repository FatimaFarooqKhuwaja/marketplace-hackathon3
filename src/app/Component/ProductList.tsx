...
import dots from '../assets/NikeLogo.png'
...
const ProductsList = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      const query = '*[_type == "product" || _type == "male" || _type == "female" || _type == "kids"]{_id, productName, price, category, slug, status, description, "image": image.asset->url, colors}'
