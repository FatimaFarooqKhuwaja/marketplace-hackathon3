  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-y-[20px] mt-[30px] mb-[30px]">
      <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-lg">
        ...
        {/* Heading */}
        <h1 className="text-[22px] font-[600] text-center mb-6">
        ...
        <form className="space-y-4" onSubmit={onSubmit}>
          ...
          <p className="text-center text-sm text-[#8D8D8D] mb-6">
            By logging in, you agree to Nikes <span className="underline">Privacy</span> <br /> <span className="underline">Policy</span> and <span className="underline">Terms of Use</span>.
          </p>
          ...
          <button
            type="submit"
            className="w-full py-3 mt-6 bg-black text-white text-lg font-semibold rounded-md hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
            Sign In
          </button>
        </form>
